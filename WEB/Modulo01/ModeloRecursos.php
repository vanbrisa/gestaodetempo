    ...
    <?php include('layout/menu.php') ?>
        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <!-- botão -->
                <button type="button" class="btn CorVerdeClaroEstado" data-toggle="tooltip" data-placement="top" title="Tooltip na parte superior"> <strong>Tooltip na parte superior</strong></button>
                <!-- fim Botão -->
